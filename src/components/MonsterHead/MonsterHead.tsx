...
export const MonsterHead = ({ id, name,info}: { id: number; name: string,info:brife_info }) => {
	return (
		<div className={styles.head}>
			<a>
				<img className={styles.headimg} src={`https://seerh5.61.com/resource/assets/pet/head/${id}.png`}></img>
				<p style={{position:'relative',bottom:'30px',backgroundColor:'#00000080',color:'white',width:'89px',left:"9px"}}>{name}</p>
			</a>
